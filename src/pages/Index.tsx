  ...
  return (
    <Layout>
      ...
      <section className="relative h-[85vh] min-h-[580px] flex items-center overflow-hidden">
        ...
        <div className="relative container z-10">
          <div className="max-w-2xl">
            ...
            <h1 className="font-heading text-[2.5rem] md:text-5xl lg:text-[3.5rem] leading-[1.1] text-white mb-4 animate-fade-in-up">
      ...
      {notifications.length > 0 && (
        <div className="bg-maroon text-white py-2.5 overflow-hidden relative">
          <div className="absolute left-0 inset-y-0 w-20 bg-gradient-to-r from-maroon to-transparent z-10" />
          <div className="absolute right-0 inset-y-0 w-20 bg-gradient-to-l from-maroon to-transparent z-10" />
        ...
        <div className="container">
          <div className="grid grid-cols-2 md:grid-cols-4 gap-3 md:gap-4">
            {[
              ...
              <div key={s.label} className="text-center p-5 md:p-6 rounded-lg bg-white shadow-xl shadow-black/5 border border-border premium-card animate-count-up" style={{ animationDelay: `${i * .08}s` }}>
      ...
      <section className="py-20 bg-white">
        <div className="container">
          <div className="grid lg:grid-cols-2 gap-14 items-center">
            <div>
              <span className="text-gold-dark font-bold text-[10px] uppercase tracking-[.25em] mb-3 block">Welcome to MEC</span>
              ...
              <Link to="/about/about-mec" className="inline-flex items-center gap-2 px-6 py-2.5 bg-primary text-white rounded hover:brightness-110 transition-all font-semibold text-sm">
            ...
            <div className="relative">
              ...
              <div className="absolute -top-4 -right-4 px-5 py-4 bg-gold text-white rounded-lg shadow-lg hidden md:block">
      ...
      <section className="py-20 bg-cream">
        <div className="container">
          <div className="text-center mb-12">
            <span className="text-gold-dark font-bold text-[10px] uppercase tracking-[.25em] mb-3 block">Academic Excellence</span>
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-4">
            {departments.map(dept => (
              <Link key={dept.code} to={`/department/${dept.code}`} className="group flex items-center gap-4 bg-white rounded-lg p-5 border border-border hover:border-primary/30 hover:shadow-lg transition-all duration-300">
      ...
      <section className="py-20 bg-white">
        <div className="container">
          <div className="text-center mb-12">
            <span className="text-gold-dark font-bold text-[10px] uppercase tracking-[.25em] mb-3 block">Why MEC</span>
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-5">
            {[
              ...
              <div key={item.title} className="p-7 rounded-lg bg-white border border-border premium-card group text-center shadow-sm">
      ...
      <section className="py-20 bg-cream">
        <div className="container">
          <div className="flex flex-col md:flex-row md:items-end justify-between mb-10 gap-4">
            <div>
              <span className="text-gold-dark font-bold text-[10px] uppercase tracking-[.25em] mb-2 block">Stay Updated</span>
          ...
          {events.length > 0 ? (
            <div className="grid md:grid-cols-3 gap-5">
              {events.slice(0, 6).map(e => (
                <div key={e.id} className="rounded-lg overflow-hidden bg-white border border-border premium-card group shadow-sm">
                  {e.imageUrl && (
                  ...
                  <div className="p-5">
                    <div className="flex items-center gap-2 text-xs text-muted-foreground mb-2.5">
                      <Calendar size={12} className="text-gold-dark" /><span className="font-medium">{e.date}</span>
      ...
      <section className="py-20 bg-white">
        <div className="container">
          <div className="flex flex-col md:flex-row md:items-end justify-between mb-10 gap-4">
            <div>
              <span className="text-gold-dark font-bold text-[10px] uppercase tracking-[.25em] mb-2 block">Campus Life</span>
      ...
      <section className="py-20 bg-cream">
        <div className="container">
          <div className="text-center mb-12">
            <span className="text-gold-dark font-bold text-[10px] uppercase tracking-[.25em] mb-3 block">Pride of MEC</span>
            ...
            <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
              {achievers.slice(0, 8).map(a => (
                <div key={a.id} className="text-center p-6 rounded-lg bg-white border border-border premium-card shadow-sm">
                  ...
                  {a.year && <p className="text-xs text-gold-dark font-bold mt-1.5">{a.year}</p>}
                </div>
              ))}
            </div>
          ) : (
      ...
      <section className="py-20 bg-white">
        <div className="container">
          <div className="text-center mb-12">
            <span className="text-gold-dark font-bold text-[10px] uppercase tracking-[.25em] mb-3 block">Contact</span>
